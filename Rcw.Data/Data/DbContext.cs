...
namespace Rcw.Data
{
    ...
    public static class DbContext 
    {
        ...
        {   //SqlServer数据库
            ...
            dsSources.Add("ltzn39", new Oracle.OracleDataSource("ltzn39", "Data Source=192.168.2.3/xgmes;User ID=LF;Password=LF;"));
        ...
        /// <returns></returns>
        internal static DbEntityInfo GetDbEnityInfo(Type entityType)
        {
        ...
        /// <param name="prefix">前缀</param>
        /// <returns></returns>
        public static int GetSeqNum(string dsName, string prefix)
        {
